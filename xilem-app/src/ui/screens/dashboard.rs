        ...
        flex((
            ...
            flex((
                metric_display(
                    ...
                    Color::from_rgb8(0, 114, 178), // Colorblind-safe blue
                ),
                metric_display(
                    "Accuracy",
                    ...
                    if data.current_metrics.accuracy_rate >= 0.85 {
                        ...
                        Color::from_rgb8(0, 114, 178) // Colorblind-safe blue
                    } else if data.current_metrics.accuracy_rate >= 0.55 {
                        Color::from_rgb8(240, 228, 66) // High-contrast yellow
                    } else {
                        Color::from_rgb8(213, 94, 0) // Colorblind-safe vermillion
                    },
                ),
            ))
            .direction(Axis::Horizontal),
            ...
            flex((
                metric_display(
                    ...
                    Color::from_rgb8(230, 159, 0), // Colorblind-safe orange
                ),
                metric_display(
                    "Best Streak",
                    data.current_metrics.best_streak.to_string(),
                    Color::from_rgb8(86, 180, 233), // Colorblind-safe sky blue
                ),
            ))
            .direction(Axis::Horizontal),
            // Performance rating
